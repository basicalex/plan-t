...
// This code reads the values of different sensors and controls the water pump and fertilizer pump
// The water pump is controlled by the soil moisture sensor
// The fertilizer pump is controlled by the luminosity sensor
// The water pump is on when the soil moisture is below a certain threshold
// The fertilizer pump is on when the luminosity is below a certain threshold
// The soil moisture sensor is analog
// The luminosity sensor is analog
// The humidity sensor is analog
// The CO2 sensor is analog
// The CO sensor is analog
// The water pump is digital
// The fertilizer pump is digital
// The DHT sensor is digital
